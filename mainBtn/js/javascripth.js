...
function textChanged(text,text2){
  ...
  document.getElementById('img1').src = dictionary1[text[0]];
  document.getElementById('img2').src = dictionary1[text[1]];
  document.getElementById('img3').src = dictionary1[text[2]];
  document.getElementById('img4').src = dictionary1[text[3]];
